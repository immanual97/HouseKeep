...
from users.models import Customer, Service, Technician, Admin,WorkRequest
...
from users.serializer import AdminChangePasswordSerializer,TechnicianChangePasswordSerializer,CustomerChangePasswordSerializer
...
def workrequestregisterApi(request,id=0):
    if request.method=='POST':
        ...
        workrequest_serializer = WorkRequestSerializer(data=workrequest_data)
